...
1. [Use Microsoft Entra ID for cache authentication with Azure Managed Redis](/azure/redis/entra-for-authentication)
1. [Monitor Azure Cache for Redis](/azure/redis/monitor-cache)
